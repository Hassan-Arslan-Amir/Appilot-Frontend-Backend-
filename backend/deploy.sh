...
#Mian files for the new input:
# useSaveTask.jsx  inside frontend/src/Components/Hooks/useSaveTask.jsx  to add the local url
# utils.jsx inside frontend/src/Utils/utils.jsx  in transformData function to add the input for the new task
# input.jsx inside frontend/src/Components/Tasks/Task/Input/input.jsx to add a new case of the input type
# Save.jsx inside frontend/src/Components/Tasks/Task/Save/Save.jsx to add a new case of the save type

#To See logs in terminal
# adb logcat --pid=4973
